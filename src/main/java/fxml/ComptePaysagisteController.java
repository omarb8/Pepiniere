 ...
 * @author aisce
 */
public class ComptePaysagisteController implements Initializable {
   ...
   private String path;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
         ...
         //String userdirectoryS =System.getProperty(path);
        //File  userDirectory = new File(userdirectoryS);
        path=as.modifImg(HomeController.username);
        //System.out.println("you are waiting for"+path);         
        ...
        //Dphoto.setImage(new Image(getClass().getResource("/fxml/Default.jpg").toString()));
         //Image image = new Image(as.modifImg(HomeController.username));
...
//affectation de N
        ...
        User old =new User(oldnom, oldPrenom, oldtelephone, oldemail, oldpassword, "Paysagist", oldusername, oldusername, oldemail,id);
        User apres=new User(newnom, newPrenom, newtelephone, newemail, newpassword, "Paysagist", newusername, newusername, newemail, id);
