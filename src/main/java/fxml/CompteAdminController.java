...
//affectation de N
        ...
        User old =new User(oldnom, oldPrenom, oldtelephone, oldemail, oldpassword, "Admin", oldusername, oldusername, oldemail,id);
        User apres=new User(newnom, newPrenom, newtelephone, newemail, newpassword, "Admin", newusername, newusername, newemail, id);
