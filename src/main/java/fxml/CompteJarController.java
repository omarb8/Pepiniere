...
import static fxml.HomeController.username;
 ...
 * @author aisce
 */
public class CompteJarController implements Initializable {
...
//affectation de N
        ...
        User old =new User(oldnom, oldPrenom, oldtelephone, oldemail, oldpassword, "Jardinier", oldusername, oldusername, oldemail,id);
        User apres=new User(newnom, newPrenom, newtelephone, newemail, newpassword, "Jardinier", newusername, newusername, newemail, id);
